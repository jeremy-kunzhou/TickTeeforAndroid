...
import com.huhukun.utils.ViewIdGenerator;
...
public class ExtendedCalendarView extends RelativeLayout implements OnItemClickListener,
    ...
    private int baseId = ViewIdGenerator.generateViewId();
    private int preId = ViewIdGenerator.generateViewId();
    private int nextId = ViewIdGenerator.generateViewId();
    private int monthId = ViewIdGenerator.generateViewId();
