...
//	OnAddNewEventClick mAddEvent;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(position >= 0 && position < 7){
            ...
            if(d.getYear() == cal.get(Calendar.YEAR) && d.getMonth() == cal.get(Calendar.MONTH) + 1 && d.getDay() == cal.get(Calendar.DAY_OF_MONTH)){
...
//            dayTV.clearFocus();
//            dayTV.setActivated(false);
//            dayTV.setPressed(false);
    ...
    public void refreshDays()
    {
        ...
        for(int i=j-1;i<days.length;i++) {
            ...
            cTemp.set(Calendar.DAY_OF_MONTH, dayNumber);
